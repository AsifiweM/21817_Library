...
public class CheckInOut extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Check Availability first");
    ...
    private void CheckoutbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckoutbtnActionPerformed
        ...
        try {
            ...
            System.out.println("Book rented out successfully");
        } catch (Exception e){
    ...
    private void checkavailabilitybtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkavailabilitybtn1ActionPerformed
        ...
        if (list.isEmpty()){
            jLabel4.setText("This book has not been rented out");
            returnbookbtn.setEnabled(false);
        } else {
        book = list.get(0);
    ...
    private void checkavailabilitybtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkavailabilitybtnActionPerformed
        ...
        Query query = session.createQuery(sql);
        List<Checkinout> list = query.list();
        authorlabel.setText(list.get(0).getBook().getAuthor());
        titlelabel.setText(list.get(0).getBook().getTitle());
        if (list.isEmpty()){
        ...
        switch (book.getStatus()) {
            case "Available":
                jLabel4.setText(book.getStatus());
                Checkoutbtn.setEnabled(true);
                break;
            case "Rented":
                jLabel4.setText(book.getStatus());
...
//        Transaction transact = session.beginTransaction();
//        
//        Checkinout book = (Checkinout)session.load(Checkinout.class, 1);
//        
